<?php
	...
	<?php 
		...
		$sql ="SELECT * FROM comments as c INNER JOIN users as u ON c.user_id=u.user_id INNER JOIN books as b ON c.book_id=b.book_id WHERE c.user_id=".$user_id." ORDER BY c.comment_date DESC";
		...
		while ($row = $q -> fetch_assoc()) {
			echo"<article>";
				echo"<h3><a href=\"comments.php?book_id=".$row['book_id']."\">".$row['book_title']."</a></h3>";
				echo"<p>".$row['msg']."</p>";
